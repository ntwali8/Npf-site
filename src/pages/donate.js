        ...
        <div className="my-16">
          ...
          <div>
            ...
            <div className="mx-16">
              ...
              <div className="my-10">
                <input
                  className="w-full border-2 border-black p-5 text-black font-bold"
                  type="text"
                  id="cardNumber"
                  name="cardNumber"
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-5 my-10">
                ...
                <input
                  className="border-2 border-black p-5 text-black font-bold"
                  type="text"
                  id="cardNumber"
                  name="cardNumber"
                  placeholder="March"
        ...
        <div className="my-16 py-10 border-t-2 border-red-500">
          ...
          <div className="mx-16">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
              ...
              />
              <input
                className="border-2 border-black p-5 text-black font-bold md:col-span-2 lg:col-span-2"
                type="text"
                id="email"
                name="email"
                placeholder="Email"
