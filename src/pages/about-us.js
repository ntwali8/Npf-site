        ...
        <main>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 mx-20 lg:mx-36 mt-30">
                <p className="inline-block text-xl order-2 md:order-1 lg:order-1">
                    ...
                    with God and victims of crime for the transformation and restoration 
                    of hope to all those involved and affected by crime within and outside Uganda
                </p>
            ...
            <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-2 items-center p-20 bg-gray-400">
                <div className="inline-block text-center max-w-lg mx-auto">
                    ...
                    <img alt="" src={ mission} className="mx-auto my-5 h-auto lg:w-4/5" />
                </div>
                <p className="inline-block text-xl lg:text-right">
                    ...
                    reconciliation and restoration of hope to prisoners, ex-prisoners and their 
                    families with victims of crime within and outside Uganda.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 items-center justify-between px-16 py-16 bg-gray-200">
                <div className="inline-block text-center lg:mx-10">
                    ...
                    <div className="max-w-lg">
                        <img alt="" src={ spectacles } className="mx-auto my-5 w-3/5 md:w-3/5 lg:w-2/5 h-auto" />
                    </div>
                    <p className="text-left text-xl">
                        Prison Fellowship was founded in the United States in 1976 by 
                        Charles W. Colson, following his release from prison after serving a sentence 
                        for a "Watergate" related crime. Prior to his imprisonment, Mr. Colson had 
                        served as chief counsel for President Richard Nixon.<br/><br/>
                        During his own imprisonment, Mr. Colson had seen and experienced the difference 
                        that faith in Jesus Christ makes in the lives of people and he became convinced 
                        that the real solution to crime is found through spiritual renewal.
                    </p>
                </div>
                <p className="inline-block text-xl text-left lg:mx-10">
                    Three years after the formation of Prison Fellowship in the United States, 
                    representatives from similar organizations in England, Australia, Canada, 
                    New Zealand and the Bahamas met to form Prison Fellowship International as an 
                    association of national Prison Fellowship organizations.<br/><br/>
                    The purpose of PFI was to develop and serve national Prison Fellowship organizations.
                    Since 1979, Prison Fellowship International has grown to encompass national PF 
                    organizations in over 115 countries around the world.<br/><br/>
                    Most of this growth has occurred under the leadership of Ron Nikkel, the President 
                    of PFI, who for more than 25 years has traveled throughout the world promoting and 
            ...
            <div className="px-10 py-10 bg-gray-400">
                <div className="text-center">
                    ...
                    <p className="text-lg font-semibold">
                        The Prison Fellowship Board of Directors draws on the wisdom and experience of 
                        its diverse members to move the ministry forward with integrity and excellence.
                    </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8 m-5">
                    <img alt="" src={ black } className="w-4/5 h-auto mx-auto" />
                    <img alt="" src={ black } className="w-4/5 h-auto mx-auto"/>
                    <img alt="" src={ black } className="w-4/5 h-auto mx-auto"/>
                    <img alt="" src={ black } className="w-4/5 h-auto mx-auto"/>
                    <img alt="" src={ black } className="w-4/5 h-auto mx-auto"/>
            ...
            <div className="px-10 py-10">
                <div className="text-center">
                    ...
                    <p className="text-lg font-semibold m-5">
                        Prison Fellowship's Leadership is composed of seasoned experts, leading 
                        the ministry with collaboration, transparency, and accountability.
                    </p>
                    <div className="text-center lg:m-4">
                        <img alt="" src={ black } className="w-4/5 h-auto mx-auto lg:w-1/4" />
